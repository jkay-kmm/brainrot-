...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider.value(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: const Text('brainrot', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
          actions: [
        ...
        children: [
                  ...
                  return ClipRRect(
                    ...
                    child: Image.asset(
                      ...
                      errorBuilder: (context, error2, stackTrace2) {
                        // Final fallback to icon if no images work
                        return Container(
                          width: 120,
                          height: 120,
                          decoration: BoxDecoration(
          ...
          Container(
            ...
            child: Stack(
              children: [
                Container(
                  width: MediaQuery.of(context).size.width * (finalScore / 100) * 0.85, // Adjust for padding
                  height: 8,
                  decoration: BoxDecoration(
                    color: _getScoreColor(finalScore),
                    borderRadius: BorderRadius.circular(10),
          ...
          Row(
            ...
            children: [
              ...
              const SizedBox(width: 8),
              GestureDetector(
                onTap: () => _showHealthCalculationDetails(context, homeViewModel, totalMinutes, goalMinutes, finalScore),
                child: const Icon(
                  Icons.help_outline,
                  size: 20,
                  color: Colors.grey,
  ...
  void _showHealthCalculationDetails(BuildContext context, HomeViewModel homeViewModel, int totalMinutes, int goalMinutes, double finalScore) {
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        if (totalMinutes <= goalMinutes) ...[
                          _buildCalculationRow('impact', '${(totalMinutes / 60).toStringAsFixed(1)} hrs * ${(preGoalImpact / (totalMinutes / 60)).toStringAsFixed(1)}/hr', 
                        ...
                        _buildCalculationRow('final score', '100 - total impact', 
